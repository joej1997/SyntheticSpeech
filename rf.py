...
where_train_trump = np.where(df_chr_trump["test_train_Part1"]=="Train")[0]
where_test_trump = np.where(df_chr_trump["test_train_Part1"]=="Test")[0]
...
where_train_drake = np.where(df_chr_drake["test_train_Part1"]=="Train")[0]
where_test_drake = np.where(df_chr_drake["test_train_Part1"]=="Test")[0]
...
#split takei
where_train_takei = np.where(df_chr_takei["test_train_Part1"]=="Train")[0]
where_test_takei = np.where(df_chr_takei["test_train_Part1"]=="Test")[0]
